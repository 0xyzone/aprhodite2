            ...
            <div>
                <x-input-with-icon-wrapper>
                    ...
                    <x-input withicon id="fullName" class="block w-full" type="text" name="fullName" :value="old('fullName')"
                        placeholder="{{ __('Search order') }}" autofocus="true" wire:model="search" />
                </x-input-with-icon-wrapper>
                            ...
                            <tr class="table-rows"">
                                ...
                                <td
                                    ...
                                    <div class="flex gap-2 justify-center">
                                        ...
                                        <x-fas-eye class="w-5" @click="order = {{ $var->id }}"
                                ...
                                <td colspan="100%">
                                    <div class="relative overflow-hidden transition-all max-h-0 duration-700 flex justify-between w-full px-16"
                                        ...
                                        <div class="grid grid-cols-1 lg:grid-cols-4 space-x-2 w-full">
                                            <div class="w-full flex items-center gap-2"><x-fas-user class="w-4" /><span>{{ $var->fullName }}</span></div>
                                        </div>
                                    </div>
                                </td>
                            </tr>
