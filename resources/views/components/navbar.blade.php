...
<div class="fixed z-[99] inset-x-0 bottom-0 flex items-center justify-between px-4 py-4 sm:px-6 transition-transform duration-500 bg-white md:hidden dark:bg-dark-eval-1"
    ...
    <x-button type="button" iconOnly variant="secondary" srText="Search" disabled class="hidden">
    ...
    <x-button type="button" iconOnly variant="secondary" srText="Open main menu"
        ...
        <x-heroicon-o-squares-2x2 x-show="!isSidebarOpen" aria-hidden="true" class="w-6 h-6" />
