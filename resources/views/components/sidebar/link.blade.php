...
@php
    $isActiveClasses =  $isActive ? 'text-white bg-lime-600 shadow-lg hover:bg-lime-600' : 'text-gray-500 hover:text-gray-700 hover:bg-gray-100 dark:hover:text-gray-300 dark:hover:bg-dark-eval-2';
